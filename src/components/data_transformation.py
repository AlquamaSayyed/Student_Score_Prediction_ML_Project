...
class DataTransformationClass:
    ...
    def get_data_transformer_object(self):
        """This function is responsible to get data transformer object"""
        try:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Read trian and test dataset completed")
            ...
            logging.info("Applying transformation on train and test data set")
            ...
            save_object(self.data_transformation_config.preprocessor_obj_file_path,preprocessing_object)
